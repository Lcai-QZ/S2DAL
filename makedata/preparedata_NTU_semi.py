...
parser.add_argument('--ntu_path_semi', type=str, default='/mnt/disk/dataset/RainDrop/raindrop_semitrain_data/',
                    help="Path to save the original NTURain datasets, (default: None)")
parser.add_argument('--train_path', type=str, default='/mnt/disk/dataset/RainDrop/train_semi_256/',
                    help="Path to save the prepared training datasets, (default: None)")
parser.add_argument('--patch_size', type=int, default=64,
                    help="Patch size for cropping")           #default=64
parser.add_argument('--batch_size', type=int, default=10,
                    help="Batch size for saving data")        #default=12
