...
parser.add_argument('--train_path', type=str, default='/media/zyserver/data16t/cailei/data/weather/allweather/allweather_train_mat_128_shuffle_label_more',
...
rainhaze_img_num = rainhaze_data.shape[2]
...
raindrop_data = merge_dims(raindrop_data_rerange, 0, 2)  ## 合并 0 和 2 维度 num_patch * 3 * 128 * 128
gt_raindrop_data = merge_dims(gt_raindrop_data_rerange , 0, 2)  ## 合并 0 和 2 维度 num_patch * 3 * 128 * 128
