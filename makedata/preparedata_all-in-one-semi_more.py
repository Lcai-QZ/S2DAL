...
parser.add_argument('--train_path', type=str, default='/media/zyserver/data16t/cailei/data/weather/allweather/allweather_train_semi_mat_128_more',
...
for ss in range(ceil(8 / 2)):
    ...
    for nn in range(rainhaze_img_num):
