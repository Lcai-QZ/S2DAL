...
parser.add_argument('--train_path', type=str, default='/media/zyserver/data16t/cailei/data/weather/allweather/allweather_train_semi_mat_128_no_label_shuffle',
...
for ss in range(ceil(allweather_patch_number / args.batch_size)):
    ...
    #         savemat(str(save_patch), {'rain_data': single_allweather_data_batch.squeeze(2)})
    #     else:
