...
# 构建网络
print('Loading from {:s}'.format(str(Path('/media/zyserver/data16t/cailei/project_SAHistorFomer/SAHistoFormer_V2/models_save_allweather_text_guided_degration_more_0.5_with_ssim/model_best_ssim_raindrop8.pt'))))
model = define_network(deepcopy(opt['network_g'])).cuda()
# model = DerainNet(n_features=32, n_resblocks=8).cuda()
state_dict = torch.load(str(Path('/media/zyserver/data16t/cailei/project_SAHistorFomer/SAHistoFormer_V2/models_save_allweather_text_guided_degration_more_0.5_with_ssim/model_best_ssim_raindrop8.pt')))
